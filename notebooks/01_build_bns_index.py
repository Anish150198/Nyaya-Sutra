...
# MAGIC %md
# MAGIC # 01 — Build BNS (Bharatiya Nyaya Sanhita) FAISS Index
# MAGIC
# MAGIC 1. Loads all BNS section JSON files from `data/bronze/laws/BNS/`
...
# MAGIC 5. Saves to `data/gold/faiss/bns/`
...
for q in ['What is the punishment for murder?', 'What constitutes theft under BNS?', 'Provisions about bail']:
    print(f'\n--- Query: {q} ---')
